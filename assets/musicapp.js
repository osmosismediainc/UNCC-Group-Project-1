$(document).ready(function () {
  ...
  var settings = {
    "async": true,
    "crossDomain": true,
    "url": "https://audd.p.rapidapi.com/findLyrics/?q=" + lyrics + apiKey,
    "method": "GET",
    "headers": {
  ...
  $.ajax(settings).done(function (response) {
    ...
    // var queryURL = "https://cors-anywhere.herokuapp.com/https://api.audd.io/findLyrics/?q=" + lyrics + apiKey;
